...
import com.my_bank_v1.BankApp_v1.repository.PaymentRepository;
import com.my_bank_v1.BankApp_v1.repository.TransactRepository;
...
public class TransactController {
    ...
    public String payment(@RequestParam("beneficiary")String beneficiary,
        ...
        if(currentBalance < paymentAmount){
            ...
            paymentRepository.makePayment(acc_id, beneficiary, account_number, paymentAmount, reference, "failed", reasonCode, currentDateTime);
            // Log Failed Transaction:
            transactRepository.logTransaction(acc_id, "Payment", paymentAmount, "online", "failed", "Insufficient Funds", currentDateTime);
            redirectAttributes.addFlashAttribute("error", errorMessage);
            return "redirect:/app/dashboard";
        }
