...
import com.my_bank_v1.BankApp_v1.helpers.HTML;
import com.my_bank_v1.BankApp_v1.helpers.Token;
import com.my_bank_v1.BankApp_v1.mailMessenger.MailMessenger;
...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser") User user,
        ...
        MailMessenger.htmlEmailMessenger("no-reply@advancebank.me", email, "Verify Account", emailBody);
